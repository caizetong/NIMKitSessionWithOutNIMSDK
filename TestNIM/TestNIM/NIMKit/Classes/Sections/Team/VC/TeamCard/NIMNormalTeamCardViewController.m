...
@interface NIMNormalTeamCardViewController ()<
...
- (void)refreshTableHeader:(CGFloat)width{
    NIMKitCardHeaderOpeator opeartor = CardHeaderOpeatorAdd | CardHeaderOpeatorRemove;
...
- (void)refreshTitle{
    self.navigationItem.title = @"_dataSource.team.teamName;";//_dataSource.team.teamName;
}
